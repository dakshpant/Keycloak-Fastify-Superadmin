...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center bg-primary justify-between gap-2 px-6 py-3.5 lg:py-3.5">
        <NavLink to="/">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-4 py-4 px-3 lg:mt-4 lg:px-4">
          {/* <!-- Menu Group --> */}
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 mb-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-lightgreen dark:hover:bg-meta-4 ${
                    pathname=='/' &&
                    'bg-lightgreen dark:bg-meta-4 text-primary font-semibold border-l-[3px] border-solid border-primary'
                  }`}
                >
                  <svg
                          className="fill-current"
              ...
              <li>
                <NavLink
                  to="/modules"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 mb-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-lightgreen dark:hover:bg-meta-4 ${
                    pathname.includes('profile') && 'bg-lightgreen text-primary dark:bg-meta-4 font-semibold border-l-[3px] border-solid border-primary'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <!-- Menu Item Product Catalog --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/productcatalog' || pathname.includes('productcatalog')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 mb-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-lightgreen dark:hover:bg-meta-4 ${
                          (pathname === '/productcatalog' || pathname.includes('productcatalog')) &&
                          'bg-lightgreen dark:bg-meta-4 text-primary font-semibold border-l-[3px] border-solid border-primary'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-black dark:text-white duration-300 ease-in-out ' +
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-lightgreen dark:hover:bg-meta-4 ${
                          (pathname === '/ui' || pathname.includes('ui')) &&
                          'bg-lightgreen dark:bg-meta-4 text-primary font-semibold border-l-[3px] border-solid border-primary'
                        }`}
                        onClick={(e) => {
