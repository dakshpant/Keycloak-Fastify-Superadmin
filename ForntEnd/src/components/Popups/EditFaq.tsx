    ...
    return (
        <>
            <div
                ...
                role="dialog"
                aria-modal="true"
            onClick={() => { props.setEditFaqpopup(false) }}
            >
                <div
                    ...
                    >
                        <div className="relative transform  rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[47rem]">
                            <button
                                ...
                                onClick={() => props.setEditFaqpopup(!props.editFaqPopup)}
                            >
                                                    ...
                                                    <form action="#" onSubmit={handleSubmit}>
                                                        ...
                                                        <div className="mb-5.5">
                                                            ...
                                                            <textarea
                                                                ...
                                                                defaultValue='Lorem ipsum dolor sit amet consectetur. Aliquet egestas nulla faucibus.'
                                                            >
