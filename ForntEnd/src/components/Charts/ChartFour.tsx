...
const options: ApexOptions = {
    chart: {
      ...
      xaxis: {
        categories: ['Attendance', 'Payroll', 'Live Tracking', 'Activity Management', 'Ground Ops'],
      },
      yaxis: [
        {
          title: { text: 'Net Profit ($ thousands)' },
      ...
      <div>
        ...
        <div>
          <div className="relative z-20 inline-block">
            ...
            >
              <option value="" className='dark:bg-boxdark selected disabled'>Time Period</option>
